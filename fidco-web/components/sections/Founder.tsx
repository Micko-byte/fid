    ...
    >
      ...
      >
        ...
        <div className="founder-grid">
          ...
          >
            <TiltedCard
              imageSrc="https://res.cloudinary.com/dnrj0hbpy/image/upload/f_auto,q_auto,w_1800,c_limit/FID/farida-studio"
              ...
              overlayContent={
                <>
                  ...
                  <img
                    src="https://res.cloudinary.com/dnrj0hbpy/image/upload/f_auto,q_auto,w_1800,c_limit/FID/farida-seated"
                    alt=""
                    aria-hidden
                    style={{
                      position: "absolute",
