...
export default function MobileHome() {
  ...
  return (
    <div style={{ overflowX: "hidden" }}>
          ...
          const Dial = (i: number) => {
            ...
            return (
              <FadeUp key={s.slug} delay={(i % 2) * 0.06}>
                <Link href={`/services/${s.slug}`} style={{ background: "none", border: "none", padding: 0, cursor: "pointer", display: "block", textDecoration: "none" }}>
                  <RadialDial
                    label={s.label}
                    tone="dark"
                    dots={s.dots}
      ...
      {/* ── SELECTED WORK — editorial cards, same as the /work page ── */}
      <div style={{ padding: `${PY} ${PX} 0`, background: "#efe9df" }}>
        <MobileSectionHead title="Our Work" href="/work" label="View all" tone="light" />
      </div>
      <WorkSectorEditorial />
