...
const GridMotion: FC<GridMotionProps> = ({ items = [], gradientColor = "#1a0306" }) => {
  ...
  return (
    <div ref={gridRef} className="h-full w-full overflow-hidden">
      <section className="w-full h-full overflow-hidden relative flex items-center justify-center" style={{ background: `radial-gradient(circle, ${gradientColor} 0%, transparent 100%)` }}>
              ...
              {Array.from({ length: 7 }, (_, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="relative">
                    <div className="relative w-full h-full overflow-hidden rounded-[10px] bg-[#1a0306] flex items-center justify-center text-white text-[1.5rem]">
