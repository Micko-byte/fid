...
const AngledCard = ({
    ...
    return (
        ...
        >
            <div className="relative h-full w-full overflow-hidden border border-white/10 bg-muted min-h-[300px] shadow-2xl rounded-lg">
                <Image
                    src={item.url}
...
export const AngledSlider = ({
    ...
    return (
        <div
            className={cn(
                "relative w-full overflow-hidden py-10 perspective-1000",
                className
            )}
            style={{
