    ...
    <>
      <nav
        style={{
          ...
          borderBottom: scrolled ? "1px solid rgba(117,0,6,0.12)" : "1px solid transparent",
          background: scrolled ? "rgba(245,242,236,0.98)" : "rgba(245,242,236,0.92)",
          backdropFilter: "blur(20px) saturate(1.2)",
          boxShadow: scrolled ? "0 10px 40px rgba(38,0,0,0.12)" : "none",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div className="nav-links-desktop" style={{ display: "flex", alignItems: "center", gap: "2.6rem" }}>
            ...
            <Link
              ...
              style={{
                ...
                boxShadow: "0 8px 22px rgba(117,0,6,0.28)",
                transition: "background 0.3s, transform 0.2s, box-shadow 0.3s",
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = "#260000"; e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 12px 28px rgba(117,0,6,0.4)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = "#750006"; e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "0 8px 22px rgba(117,0,6,0.28)"; }}
          ...
          <button
            ...
            style={{ color: "#750006", background: "none", border: "none", cursor: "pointer", width: "34px", height: "34px", display: "flex", alignItems: "center", justifyContent: "center" }}
        ...
        {menuOpen && (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.6rem clamp(1.5rem,5vw,6rem)", borderBottom: "1px solid rgba(92,60,44,0.12)" }}>
              ...
              <button onClick={() => setMenuOpen(false)} style={{ color: "#260000", background: "none", border: "none", cursor: "pointer", width: "34px", height: "34px" }} aria-label="Close menu">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" style={{ width: "26px", height: "26px" }}>
      ...
      <style>{`
        .nav-logo-chip img { height: clamp(84px, 7vw, 96px) !important; }
        .nav-logo-chip:hover { transform: translateY(-1px) scale(1.04) !important; }
        @media (max-width: 768px) {
          .nav-logo-chip img { height: 68px !important; }
