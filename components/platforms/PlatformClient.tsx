...
export default function PlatformClient({ platform: p }: { platform: OwnedPlatform }) {
  ...
  return (
    <>
      <main style={{ backgroundColor: "#FFFFFF", color: "#1c1c1c", minHeight: "100vh" }}>
        {/* ── HERO ── */}
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "1320px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "clamp(1.5rem,4vw,3rem)", marginTop: "clamp(2rem,5vw,3.5rem)" }}>
              ...
              <SplitText
                ...
                to={{ opacity: 1, y: 0 }}
                textAlign="left"
                style={{ fontFamily: "var(--font-heading,'Oswald')", fontWeight: 600, fontSize: "clamp(3rem,9vw,8rem)", color: "#1c1c1c", lineHeight: 0.9, letterSpacing: "-0.03em", textTransform: "uppercase", margin: 0 }}
              />
        ...
        <section style={{ paddingBottom: "clamp(4rem,8vw,6rem)" }}>
          <div style={{ maxWidth: "1320px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)" }}>
            <motion.div
              ...
              style={{ position: "relative", width: "100%", aspectRatio: "16/9", overflow: "hidden", backgroundColor: "#FFFFFF", borderRadius: "4px", boxShadow: "0 30px 80px rgba(117,0,6,0.15)" }}
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={p.image} alt={p.name} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, transparent 60%, rgba(38,0,0,0.55))" }} />
        ...
        <section style={{ paddingBottom: "clamp(5rem,10vw,8rem)" }}>
          <div style={{ maxWidth: "1320px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2rem,5vw,4rem)", borderTop: "1px solid rgba(28,28,28,0.1)", paddingTop: "clamp(3rem,6vw,5rem)" }} className="plat-page-grid">
              <div>
                <h3 style={{ fontFamily: "var(--font-heading,'Oswald')", fontWeight: 600, fontSize: "clamp(1.4rem,2.4vw,1.9rem)", color: "#1c1c1c", textTransform: "uppercase", letterSpacing: "-0.01em", margin: 0 }}>
                  What it delivers
                </h3>
        ...
        {p.partners && p.partners.length > 0 && (
          <section style={{ backgroundColor: "#fbf3d6", paddingTop: "clamp(4rem,8vw,6rem)", paddingBottom: "clamp(4rem,8vw,6rem)" }}>
            <div style={{ maxWidth: "1320px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-heading,'Oswald')", fontWeight: 600, fontSize: "clamp(2rem,4vw,3rem)", color: "#1c1c1c", letterSpacing: "-0.02em", marginTop: "0.8rem", marginBottom: "clamp(2rem,4vw,3rem)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "clamp(1rem,2vw,1.5rem)" }}>
                {p.partners.map((pt, i) => (
                  <motion.div
                    ...
                    style={{ padding: "1.4rem 1.5rem", backgroundColor: "#FFFFFF", border: "1px solid rgba(117,0,6,0.1)", borderLeft: `3px solid transparent`, borderRadius: "6px", cursor: "default" }}
                  >
                    <p style={{ fontFamily: "var(--font-heading,'Oswald')", fontWeight: 600, fontSize: "1.05rem", color: "#1c1c1c", textTransform: "uppercase", letterSpacing: "0.02em", margin: 0 }}>
                      {pt.name}
                    </p>
        ...
        <section style={{ position: "relative", paddingTop: "clamp(5rem,10vw,8rem)", paddingBottom: "clamp(6rem,12vw,10rem)", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, maxWidth: "1320px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)", textAlign: "center" }}>
            <h2 style={{ fontFamily: "var(--font-heading,'Oswald')", fontWeight: 600, fontSize: "clamp(2rem,5vw,4rem)", letterSpacing: "-0.02em", lineHeight: 1, marginBottom: "1.5rem", textTransform: "uppercase", background: `linear-gradient(135deg, #1c1c1c 40%, ${p.accent})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              Partner with {p.name}.
            </h2>
