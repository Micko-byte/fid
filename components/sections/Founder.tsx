        ...
        <div className="founder-grid">
          ...
          <div>
            <motion.div
              ...
              style={{ fontFamily: "var(--font-heading, 'Oswald')", fontWeight: 600, color: "#1c1c1c", fontSize: "clamp(2.6rem, 6vw, 5rem)", lineHeight: 1.0, letterSpacing: "-0.01em", marginTop: "1.4rem", textTransform: "uppercase" }}
            >
            ...
            >
              ...
              <span style={{ display: "inline-block", maxWidth: "34ch" }}>
                <VariableProximity
                  ...
                  style={{ fontFamily: '"Nohemi", var(--font-heading, "Oswald")', fontWeight: 500, letterSpacing: "-0.01em", textTransform: "none", lineHeight: 1.28, color: "#1c1c1c" }}
                />
              </span>
