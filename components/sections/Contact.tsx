      ...
      <div ref={ref} style={{ maxWidth: "1280px", margin: "0 auto", paddingLeft: "clamp(1.5rem,5vw,6rem)", paddingRight: "clamp(1.5rem,5vw,6rem)", position: "relative", zIndex: 1 }}>
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(2.5rem,6vw,5rem)", alignItems: "start" }}>
          ...
          <div style={{ textAlign: "center" }}>
            {/* Brand badge alongside the animated chat mark. */}
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "clamp(1rem,2.5vw,2rem)", marginBottom: "2rem", flexWrap: "wrap" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/brand/fid-badge.png"
                alt="FID &amp; Co. — Insight. Strategy. Impact."
                style={{ display: "block", width: "clamp(110px, 13vw, 168px)", height: "auto" }}
              />
              <ContactIcon />
            </div>
