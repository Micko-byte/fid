  ...
  return (
    <section className="af-footprint" style={{ marginTop: "clamp(3rem,6vw,5rem)", paddingTop: 0 }}>
      ...
      <div style={{ textAlign: "center", maxWidth: "44rem", margin: "0 auto clamp(2.4rem,5vw,3.6rem)" }}>
        <span style={{ display: "inline-block", fontFamily: "var(--font-body)", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: "#5A84AC", marginBottom: "0.9rem" }}>
          African footprint
        </span>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: "0.6rem",
                  border: `1px solid ${activeState ? "#5A84AC" : "rgba(92,60,44,0.16)"}`,
                  backgroundColor: activeState ? "rgba(90,132,172,0.1)" : "#FFFFFF",
      ...
      <style>{`
        ...
        .af-map[data-active="TZ"] svg path#TZ {
          ...
          fill: #5A84AC;
          stroke: #742F14;
          filter: drop-shadow(0 0 10px rgba(90,132,172,0.35));
        }
      `}</style>
    </section>
  );
