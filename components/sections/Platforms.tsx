...
export default function Platforms() {
  ...
  return (
    <section id="platforms" style={{ position: "relative", overflow: "hidden", backgroundColor: "#FFFFFF", paddingTop: "clamp(5.5rem,12vw,11rem)", paddingBottom: "clamp(5.5rem,12vw,11rem)" }}>
