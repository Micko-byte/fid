...
function WorkCard({ project, index }: { project: typeof projects[0]; index: number }) {
  return (
    ...
    >
      ...
      >
        {/* Corner frame */}
        <div style={{ position: "absolute", inset: "0.7rem", border: "1px solid rgba(217,171,136,0.22)", pointerEvents: "none", zIndex: 2 }} />
        <span
          style={{
            position: "absolute", left: "1rem", bottom: "0.9rem",
            fontFamily: "ui-monospace, 'SF Mono', Menlo, monospace",
            fontSize: "0.64rem", letterSpacing: "0.05em",
            color: "rgba(217,171,136,0.7)", textTransform: "uppercase", zIndex: 3,
          }}
        >
        ...
        <div
          style={{
            ...
            fontSize: "clamp(4rem, 8vw, 6rem)", lineHeight: 0.85,
            color: "rgba(117,0,6,0.2)", zIndex: 1,
          }}
        >
      ...
      {/* Card info */}
      <p style={{ fontSize: "0.68rem", letterSpacing: "0.16em", textTransform: "uppercase", color: "#D98038", marginBottom: "0.6rem", fontFamily: "var(--font-body)" }}>
        {project.sector}
      </p>
      <h3
        ...
        style={{
          ...
          fontSize: "clamp(1.2rem, 1.9vw, 1.6rem)", lineHeight: 1.1,
          transition: "color 0.3s",
        }}
      >
        {project.client}
      </h3>
      <p style={{ color: "rgba(33,27,24,0.6)", fontSize: "0.92rem", lineHeight: 1.5, marginTop: "0.7rem", maxWidth: "38ch", fontFamily: "var(--font-body)" }}>
        {project.title}
      </p>
      <div
        ...
        style={{
          ...
          color: "rgba(33,27,24,0.45)", transition: "color 0.3s", fontFamily: "var(--font-body)",
        }}
      >
        View case study
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" style={{ transition: "transform 0.3s" }}>
...
export default function Work() {
  ...
  const onMouseMove = (e: React.MouseEvent) => {
    ...
    trackRef.current.scrollLeft = dragStart.current.scroll - (e.pageX - dragStart.current.x);
  };
  const onMouseUp = () => {
    setIsDragging(false);
  ...
  return (
    ...
    >
              ...
              {([-1, 1] as const).map((dir) => (
                <button
                  ...
                  style={{
                    ...
                    color: "#260000", background: "transparent", cursor: "pointer",
                    transition: "background 0.3s, color 0.3s, border-color 0.3s",
                  }}
                  onMouseEnter={(e) => { const el = e.currentTarget; el.style.background = "#750006"; el.style.color = "#F5F2EC"; el.style.borderColor = "#750006"; }}
                  onMouseLeave={(e) => { const el = e.currentTarget; el.style.background = "transparent"; el.style.color = "#260000"; el.style.borderColor = "rgba(38,0,0,0.13)"; }}
                >
      ...
      <div
        style={{ position: "relative", marginTop: "clamp(2.5rem, 5vw, 3.5rem)", paddingLeft: "clamp(1.5rem, 5vw, 6rem)" }}
      >
        <div
          ref={trackRef}
          style={{
